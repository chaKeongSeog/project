...
<body>
        ...
        <!-- Navbar Search-->
        <form action="<%=request.getContextPath() %>/notice/list" method="get" name="form1" class="d-none d-md-inline-block form-inline ml-auto mr-0 mr-md-5 my-2 my-md-0" style="text-align: center">
	  ...
	  <c:if test="{user.authority == 'admin'}">
	  	<div class="form-group"><a class="btn btn-primary" href="<%=request.getContextPath()%>/notice/registForm">글등록</a></div>
	  </c:if>
...
<script>
	function list(page){
		location.href="<%=request.getContextPath()%>/notice/list?curPage="+page
