...
<div class="row">
    ...
    <div class="col-md-8">
        <h2 class="text-center">${pds.bno}번 게시글 답변</h2>
        <form action="<%=request.getContextPath() %>/pds/answer" method="post"  name="fdsForm" enctype="multipart/form-data" onsubmit="return false;"/>
            ...
            <tr>
            	<td>
            		<div class="form-group">
				        <span class="cursor" id="addFile07"><i class="fa fa-plus-circle fa-lg"></i> 파일추가</span>
				        &nbsp;
				        <span class="cursor" id="deleteFile07"><i class="fa fa-times-circle fa-lg"></i> 파일삭제</span>
			    	</div>
            	</td>
            </tr>
            <tr>
...
$(function(){
	...
	$('#write').on('click',function(){
		...
		document.fdsForm.action = "<%=request.getContextPath()%>/pds/answer";
        document.fdsForm.submit();
	});
	
	$('#addFile07').on('click',function(){
		index++;
	...
	$('#deleteFile07').on('click',function(){
