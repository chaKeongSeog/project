...
<body>
        <h2 class="mt-4">자료실 게시판</h2>
        <!-- Navbar Search-->
        <form action="<%=request.getContextPath() %>/pds/list" method="get" name="form1" class="d-none d-md-inline-block form-inline ml-auto mr-0 mr-md-5 my-2 my-md-0" style="text-align: center">
	  ...
	  <div class="form-group"><a class="btn btn-primary" href="<%=request.getContextPath()%>/pds/registForm">글등록</a></div>
...
<script>
	function list(page){
		location.href="<%=request.getContextPath()%>/pds/list?curPage="+page
				+"&search_option=${map.search_option}"
				+"&keyword=${map.keyword}";
	}
	function detail(bno){
		location.href="<%=request.getContextPath()%>/pds/detail?bno="+bno;
	}
</script>
</body>
