...
<div class="row">
    ...
    <div class="col-md-8">
        <h2 class="text-center">문의 글쓰기</h2>
        <form action="<%=request.getContextPath() %>/qna/regist" method="post"  name="form1"onsubmit="return false;"/>
...
$(function(){
	...
	$('#write').on('click',function(){
		...
		document.form1.action = "<%=request.getContextPath()%>/qna/regist";
