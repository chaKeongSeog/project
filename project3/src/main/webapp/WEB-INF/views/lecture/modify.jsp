...
<div class="row" style="margin-left: 200px;">
    ...
    <div class="col-md-7">
        <h2 class="text-center">수강평 수정</h2>
 		<form action="<%=request.getContextPath() %>/lecture/modify" onsubmit="return false;"name="lectureModifyForm" method="post">
 			<input type="hidden" name="id" value="${user.id}"/>
 			<input type="hidden" name="eno" value="${lecture.eno}"/>
						<div class="form-row">
