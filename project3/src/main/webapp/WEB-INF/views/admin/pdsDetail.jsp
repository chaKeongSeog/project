	...
	<div class="col-lg-12 col-xl-12" style = "margin :0 auto;width:100%;">
		<div id="cal_bg" class="card shadow mb-4">
			...
			<div class="card-body">
				...
				<c:if test="${attach == '[]'}">
					<span style="font-size: 18px; font-weight: bolder;">첨부파일 없음</span>
				</c:if>
				<div class="row" style="margin-top: 10px;">
					<c:forEach var="attach" items="${attach}">
						<c:if test="${attach.originFileName != null }">
							<div class="col-md-2 col-sm-2 col-xs-12"  style="cursor:pointer;" id="file" dropdown-mode="N">
								<div class="dropdown">
					...
					<div class = "row">
						...
						<div class = "col-lg-4" style = "text-align: right;">
							<div id = "originShowbtn">
								<form id="deleteForm" action="<%=request.getContextPath()%>/admin/pdsDelete" method="post" style="float:right;">
