...
<body>
        ...
        <!-- Navbar Search-->
        <form action="<%=request.getContextPath() %>/admin/noticeList" method="get" name="form1" style="text-align: center;width:700px;">
	     ...
	     <tbody>
	     	<c:forEach var="list" items="${map.list}">
	     		<tr>
	     			...
	     			<td>${list.brd_gb}</td>
	     			<td>
	     			<a href="javascript:OpenWindow('/project3/excludes/admin/noticeDetail.do?bno=${list.bno}','공지사항 상세페이지',900,600)"> 
...
<%-- 	     				<a href="#" onclick="detail('${list.bno}')"> --%>
	     			...
	     			<td>${list.name}</td>
	     			<td>
	     				<a href="javascript:OpenWindow('/project3/admin/noticeModifyForm?bno=${list.bno}','공지사항 상세보기',800,600);" class="btn btn-primary btn-sm">수정</a>
	     				<a href="#" class="btn btn-primary btn-sm" onclick="noticedelete('${list.bno}')">삭제</a>
	     			</td>
	     		</tr>
	     	</c:forEach>
	    </tbody>
	  ...
	  <div class="form-group">
	  	...
	  	<a class="btn btn-primary pull-right" href="javascript:OpenWindow('/project3/admin/noticeregistForm?eno=${list.eno}','자료실 상세페이지',800,600)">글작성</a>
	  </div>
...
<script>
	...
	function boardDelete(){
		...
		document.boardDeleteForm.action = "<%=request.getContextPath()%>/admin/noticeDelete";
