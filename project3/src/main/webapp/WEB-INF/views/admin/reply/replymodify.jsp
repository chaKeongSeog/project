...
<div class="row">
    ...
    <div class="col-md-8" style="margin-left: -200px;">
        <h2 class="text-left" style="margin-top: 10px;">댓글 수정</h2>
        ...
        <form action="<%=request.getContextPath() %>/freeBoard/modify" method="post"  name="form1"onsubmit="return false;"/>
          ...
          <table class="table">
            ...
            <tr>
                <td>
                <textarea rows="10" cols="70" name="content" id="content" placeholder="내용" class="form-control">${reply.content}</textarea>
            ...
            <tr>
                ...
                <td colspan="2"  class="text-right">
                    <input type="button" value="댓글 수정" class="btn btn-primary " id="freemodify">
                </td>
            </tr>
...
$(function(){
	$('#freemodify').on('click',function(){
		...
		$.ajax({
			url:'/project3/admin/replymodify',
			type:'post',
			data:{"rno":rno,
				"id":id,
				"content":text,
