		...
		<div id="cal_bg" class="card shadow mb-4">
			<div class="card-header d-flex justify-content-between align-items-center" style = "text-align: center;">
				<h6 class="text-primary font-weight-bold m-0">
					<span style="color: #46546e; font-weight: bold; text-align: center;"><span id="postTit" style = "font-size: 25px; margin-left: 5px;">[${reply.rno}]번 댓글</span></span>
				</h6>
			</div>
			<div class="card-body">
				<div class="cal-area" id="calarea">
					...
					<div class = "row">
						<div class = "col-lg-6">
							<span id = "id" style="font-size: 18px; font-weight: bolder;">${reply.name}</span>
							<span id = "ctrgb">(${reply.regdate})</span>
						</div>	
					</div>
					<div class = "row">
						...
						<div class = "col-lg-4" style = "text-align: right;">
							<div id = "originShowbtn">
								<form id="deleteForm" action="<%=request.getContextPath()%>/admin/freeDelete" method="post" name="deleteForm" style="float:right;">
									<input type="hidden" name="bno" id="bno" value="${reply.rno}"/>
