...
<body>	
<div class="row">
	<div class="col-lg-8 col-xl-8" style = "margin :0 auto;width:100%;">
		<div id="cal_bg" class="card shadow mb-4">
			<div class="card-header d-flex justify-content-between align-items-center" style = "text-align: center;">
				<h6 class="text-primary font-weight-bold m-0">
					<span style="color: #46546e; font-weight: bold; text-align: center;"><span id="postTit" style = "font-size: 25px; margin-left: 5px;">${lecture.title}</span></span>
				</h6>
			</div>
			<div class="card-body">
				<div class="cal-area" id="calarea">
					...
					<div class = "row">
						<div class = "col-lg-6">
							<span id = "id" style="font-size: 18px; font-weight: bolder;">${lecture.name}</span>
							<span id = "ctrgb">(${lecture.regdate})</span>
						</div>	
						<div class = "col-lg-6" style="text-align: right;">
							<span id = "id" style="font-size: 18px; font-weight: bolder;">과목:</span>
					...
					${lecture.content}
						...
						<div class="row">
							<div class="col-9 text-left">
								[교수 ${lecture.professorname}]
								평가<span style="color: red;">${lecture.totalscore}</span>
					...
					<div class = "row">
						...
						<div class = "col-lg-4" style = "text-align: right;">
							<div id = "originShowbtn">
								<form id="deleteForm" action="<%=request.getContextPath()%>/admin/evalDelete" method="post" style="float:right;">
