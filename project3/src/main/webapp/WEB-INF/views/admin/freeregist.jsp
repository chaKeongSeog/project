...
<div class="row">
    ...
    <div class="col-md-4" style="margin-left: -200px;">
        <h2 class="text-center" style="margin-top: 10px;">자유게시판 글쓰기</h2>
	...
	$('#write').on('click',function(){
		...
		$.ajax({
			...
			,success:function(res){
				alert('글을 작성하였습니다');
				window.opener.document.location.href="<%=request.getContextPath()%>/admin/freeList";
				self.close();
			},error:function(req){
				alert('상태:'+req.status);
			},dataType:'json'
