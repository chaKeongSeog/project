...
public interface GroupDAO {
	...
	void groupMemberOut(int gno,String id);
	...
	int getGroupBoardMaxNum();
	
	void insertGroupAttach(GroupAttachVO attach);
	...
	List<TodoListVO> getTodayTodoList(int gno,String today);
	...
	void addGroupMemberOutList(int gno, String id);
